...
beforeAll((done) => {
    ...
    reactRPC.functions.Greeter.sayHello({ name: "John", lastName: " Doe", messageType: "HelloRequest" }, {}, (err, res) => {
...
beforeAll((done) => {
    reactRPC.functions.Health.check({service: "Greeter", messageType: "HealthCheckRequest"}, {}, (err, response) => {
...
beforeAll((done) => {
    reactRPC.functions.Greeter.sayHelloNested({ myName: {name: "John", lastName: " Doe", messageType: "FullName"}, messageType: "TestNested"}, {}, (err, response) => {
...
describe("ReactRPC should have services", () => {
    ...
    it("ReactRPC Greeter should have sayHelloAfterDelay service", () => {
        expect(reactRPC.functions.Greeter.sayHelloAfterDelay).not.toEqual(undefined);
    })
